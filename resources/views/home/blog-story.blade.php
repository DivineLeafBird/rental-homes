                    ...
                    <div class="single-post">
                        <div class="post-header mb-5 text-center">
                            ...
                            <div class="post-meta">
                                ...
                                <span class="text-uppercase font-sm letter-spacing-1">January 17,2023</span>
                            </div>
                        ...
                        <div class="comment-area-box media">
                            ...
                            <div class="media-body ml-4">
                                ...
                                <span class="date-comm font-sm text-capitalize text-color"><i
                                        class="ti-time mr-2"></i>June 7, 2023 </span>
                        ...
                        <div class="sidebar-wrap mt-5 mt-lg-0">
                            ...
                            <div class="sidebar-widget mb-5 ">
                                ...
                                <div class="sidebar-post-item-big">
                                    <a href=""><img src="images/news/img-1.jpg" alt=""
                                            class="img-fluid"></a>
                                    <div class="mt-3 media-body">
                                        <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                            2023</span>
                                        <h5><a href="">Meeting With Clarissa, Founder Of Purple
                                ...
                                <div class="media border-bottom py-3 sidebar-post-item">
                                    ...
                                    <div class="media-body">
                                        <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                            2023</span>
                                        <h5><a href="">Thoughtful living in los Angeles</a></h5>
                                    </div>
                                </div>
                                ...
                                <div class="media py-3 sidebar-post-item">
                                    ...
                                    <div class="media-body">
                                        <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                            2023</span>
                                        <h5><a href="">Vivamus molestie gravida turpis.</a></h5>
                                    </div>
                                </div>
                            </div>
