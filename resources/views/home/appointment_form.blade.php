...
<body>
    ...
    <section>
        <form action="{{ route('schedule_appointment', ['home' => $home->id]) }}" method="post">
            @csrf
            ...
            <label for="move_in_date">Desired Tour Date:</label>
            <input type="date" id="tour_date" name="tour_date" required>

            <label for="rental_duration">Preferred Time:</label>
