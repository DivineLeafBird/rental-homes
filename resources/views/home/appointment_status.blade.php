...
<body>
    ...
    <section>
        ...
        <div class="table-responsive" style="margin-top: 75px;">
            <h4 style="text-align: center; margin-bottom:20px;">Appointments</h4>
        ...
        <table class="table">
            ...
            @foreach ($appointments as $appointment)
                <tbody>
                    <tr>
                        <td>
                            <span>{{ $appointment->home->house_name }}</span>
                        </td>
                        <td>{{ $appointment->home->region }},{{ $appointment->home->county }} </td>
                        <td>
                            <span>{{ $appointment->home->category_name }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span>{{ $appointment->application_status }} </span>
                        </td>
                        ...
                        <td>
                            ...
                            @if ($appointment)
                                @if ($appointment->application_status == 'Declined')
                                    <a href="{{ route('delete_application', ['delete' => $appointment->id]) }}"><button
                                            class="btn btn-danger"
                                            onclick="return confirm('Are you sure you want to Delete this Rent Application?')">Delete</button></a>
                                @endif
                            @endif
