                        ...
                        @foreach ($homeRecords as $homeRecord)
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span>{{ $appointment->id_number }}</span>
                                    </td>


                                    <td>
                                        <span>{{ $appointment->home_id }}</span>
                                    </td>

                                    <td>
                                        <span>{{ $homeRecord->house_name }}</span>
                                    </td>

                                    <td>
                                        <span>{{ $homeRecord->landlord_name }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <span>{{ $appointment->tour_date }} </span>
                                    </td>

                                    <td>
                                        <span>{{ $appointment->tour_time }} </span>
                                    </td>
                                    ...
                                    <td>
                                        <span>{{ $appointment->more_info }} </span>
                                    </td>


                                    <td>
                                        @if ($appointment)
                                            @if ($appointment->application_status == 'Pending')
                                                <a class="btn btn-success"
                                                    href="{{ route('approve_appointment', ['approve' => $appointment->id]) }}">Approve</a>
                                            @elseif ($appointment->application_status == 'Approved')
                                                <span>Approved</span>
                                            @elseif ($appointment->application_status == 'Declined')
                                                <a class="btn btn-success"
                                                    href="{{ route('approve_appointment', ['approve' => $appointment->id]) }}">Approve</a>
                                            @endif
                                        @endif
                                        ...
                                        @if ($appointment)
                                            @if ($appointment->application_status == 'Pending')
                                                <a class="btn btn-danger"
                                                    ...
                                                    href="{{ route('decline_appointment', ['decline' => $appointment->id]) }}">Decline</a>
                                            @elseif ($appointment->application_status == 'Declined')
                                                <span>Declined</span>
                                            @endif
                                        @endif
